...
public class Main {
    public static void main(String[] args) {
        ...
        scoreEnglish = 50; // 변수에 데이터 재대입

        String introduction = "안녕하세요, 저는 최성용입니다.";
        System.out.println(introduction + " 앞으로 잘 부탁합니다.");

        // 이상의 명령어는 변수 + 하드코딩된 데이터로 이루어져있음.
        /*
            Java에서의 변수 명명 규칙 :
                1. 카멜 표기법(camel case) 사용
                   : 첫 문자는 소문자로 시작 / 북수의 단어로 이루어졌을 경우
                     두 번째 단어의 첫번째 문자만 대문자
                     ex ) 한 단어 : result
                     ex ) 복수 단어 : my TestResult
                2. 특수 문자 지양

                cf) python 학습 하신 분들의 경우 python 변수 표기 방식은 스네이크 표기법(snake case)
                    이라고 해서 my_test_result와 같은 방식으로 작성합니다.
         */
        ...
        System.out.println(name1 + name2 + name3);  // 결과값 152886
        // 근데 변수의 자료형이 char인데 문자가 여러개 나오는 바람에 결과값이
        // 의도한대로 나오지 않음.
        System.out.println("" + name1 + name2 + name3);  // 결과값 : 최성용

        System.out.print(name1);
        System.out.print(name2);
        System.out.print(name3);  // print는 끝나고 개행(enter) 되지 않습니다.
        ...
        /*
                ...
                그리고 sout()의 ()내부에서 가장 먼저 나온 자료형을 따라간다는 점도
                확인할 수 있습니다.

                현재 학습한 부분 : boolean / char / String
                참고 : int - integer의 축약어로 "정수"

                과제 : name1, name2, name3에 여러분들의 이름을 한글자씩 대입하여 ctrl + F10을 눌렀을 경우에
                김일이 라고 출력될 수 있도록 작성하시오.
                그리고 한줄 더 추가하시오.
                안녕하세요 제 이름은 김일이입니다.
         */
