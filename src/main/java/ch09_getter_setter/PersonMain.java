...
public class PersonMain {
    public static void main(String[] args) {
        ...
        // setter는 method 이므로 객체명.메소드();
        person1.setName("김일일");
        person1.setAge(-100);
        person1.setAddress("서울특별시 종로구");

        // getter를 경유하여 field를 조회하는 방법
        System.out.println(person1.getName());
        System.out.println(person1.getAge());
        System.out.println(person1.getAddress());

        // 여기서
        // 김일일 학생의 나이는 0살이고 주소는 서울특별시 종로구입니다. 라고 출력하도록 작성하시오.
        ...
        // chaining method를 잘 적용하려면 특정 메서드의 결과값이
        // 어떻게 되는가를 아는 것이 매우 중요합니다.

        /*
            setName() 메서드에 비지니스 로직을 추가하시오.
            1. argument로 들어온 String 데이터의 글자 수를 파악하여
            2. 4글자 초과라면 "변경할 수 없습니다."를 출력 후 기존 이름을 그대로 사용
