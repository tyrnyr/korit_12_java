...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        factory1.produce("모니터");    // 생성되었고, method 호축도 된다는 점이 문제입니다.
        /*
            이상의 개념은 익명 클래스로 Java1.1 -> 그런데 이 형식은 자주 쓰인다기 보다 추후 학습할 람다식
            (Lambda Expression)으로 대체되는 경우가 많습니다.(그리고 JavaScript에서도 동일한 방식을 사용합니다.)

            재사용하지 않고 한 번만, 즉 이 경우에는 FactroyMain에서만 한 번 쓰고 치운다면 사용하기
            좋습니다.
        ...
        // 그리고 추상 클래스가 자식 클래스에서 구현부ㅜ를 작성했으므로
        // 재정의된 대로 출력되는지 확인
        ...
        /*
            ...
            그러면 개발자인 우리는 부모 클래스에만 적힌 메서트 호출 방식과
